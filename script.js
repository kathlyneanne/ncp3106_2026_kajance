...
(function () {
  ...
  /* Homepage Explore card -> SCPES.
     ...
     Uses the SAME bottom-to-top black curtain as the other Explore cards.

     The selector also catches the existing SCPES card even if it does not
  ...
  const scpesParams = new URLSearchParams(window.location.search);

  const openedFromExplore = scpesParams.get("from") === "explore";
...
/* =========================================================
   ...
   HOMEPAGE END — FAQ + CONTACT / LEARN MORE

   Added at the end intentionally.
...
/* =========================================================
   ...
   HOMEPAGE END — EXTRA FAQ / CONTACT INTERACTION
